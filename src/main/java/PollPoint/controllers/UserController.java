...
import PollPoint.models.dto.DeleteFormDTO;
import PollPoint.models.dto.EditFormDTO;
import PollPoint.models.dto.LoginFormDTO;
import PollPoint.models.dto.PwFormDTO;
...
public class UserController {
    ...
    public String processDeleteUserForm(@ModelAttribute @Valid DeleteFormDTO deleteFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        //adjust answer counts for all polls
        for (Poll poll : pollRepository.findAll()) {
            poll.setAnswerCount(poll.getAnswers().size());
